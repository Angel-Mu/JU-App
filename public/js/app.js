...
MetronicApp.controller('AppController', ['$scope', '$rootScope', '$state', function($scope, $rootScope, $state) {
		...
		// 		return $cookieStore.get('efimed_user_data');
		// }

		$scope.logout = function() {
				// $cookieStore.remove('efimed_user_data');
				// $cookieStore.remove('efimed_user_logged');
				// $cookieStore.remove('efimed_user_profiles');
				// $cookieStore.put('efimed_user_is_logged', false);
